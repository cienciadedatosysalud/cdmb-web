import{u as s,j as e}from"./useTranslation.ChJ-2vCC.js";import"./index.CMt9tOoS.js";import"./i18n.CnFZXKic.js";const a="/cdmb-web/";function m(){const{t}=s(),o=[t("home.steps.step1"),t("home.steps.step2"),t("home.steps.step3"),t("home.steps.step4"),t("home.steps.step5"),t("home.steps.step6"),t("home.steps.step7"),t("home.steps.step8"),t("home.steps.step9")],n=o.length;return e.jsxs("div",{children:[e.jsxs("div",{className:"home-container",children:[e.jsx("img",{src:`${a}logo_builder.png`,alt:"Logo",className:"logo-img"}),e.jsxs("div",{className:"metro-container",children:[e.jsx("div",{className:"metro-line",children:e.jsx("div",{className:"progress-line"})}),o.map((i,r)=>e.jsxs("div",{className:"station",style:{left:`calc(${r/(n-1)*100}%)`},children:[e.jsx("div",{className:"circle"}),e.jsx("p",{className:"label",children:i})]},r))]})]}),e.jsxs("div",{className:"cards-container",children:[e.jsx("a",{href:`${a}about`,className:"footer-card",target:"_blank",rel:"noopener noreferrer",children:t("home.footer.about")}),e.jsx("a",{href:`${a}about#authors`,className:"footer-card",target:"_blank",rel:"noopener noreferrer",children:t("home.footer.authors")}),e.jsx("a",{href:`${a}about#funding`,className:"footer-card",target:"_blank",rel:"noopener noreferrer",children:t("home.footer.funding")}),e.jsx("a",{href:`${a}about#termsconditions`,className:"footer-card",target:"_blank",rel:"noopener noreferrer",children:t("home.footer.terms")}),e.jsx("a",{href:`${a}about#contact`,className:"footer-card",target:"_blank",rel:"noopener noreferrer",children:t("home.footer.contact")})]}),e.jsx("style",{children:`
        .home-container {
          width: 100%;
